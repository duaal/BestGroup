<%@ Page Title="" Language="C#" MasterPageFile="~/medicalRecord/medicalMaster.Master" AutoEventWireup="true" CodeBehind="nonHealth.aspx.cs" Inherits="finalProject.medicalRecord.nonHealth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="login100-more" style="background-image: url('signupStyle/images/Company-pana.png');"></div>
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<%--<form id="form1" runat="server">--%>
					<span class="login100-form-title p-b-59" style="">
						<br />
						<br />
						Registration Form NonHealth-Volunteers
					</span>
					...
					<div class="wrap-input100 validate-input" data-validate="Username is required">
						<span class="label-input100">Major</span>
						 <select name="Major" runat="server" id="Major" class="form-control selectpicker">
                          <option></option>
                          <option>Patient Navigator</option>
                          <option>Patient Visit Volunteer</option>
                          <option >Cleaning</option>
                          <option >Chemistry</option>
                          <option >Organizing patients' queues</option>
                        </select>
                ...
                <div class="wrap-input100 validate-input" data-validate="Username is required">
						<span class="label-input100">Nationality</span>
						 <select name="Nationality" runat="server" id="Nationality" class="form-control selectpicker">
                          <option></option>
                ...
                <div class="wrap-input100 validate-input" data-validate="Username is required">
						<span class="label-input100">Status</span>
						  <select name="Status" runat="server" id="Status" class="form-control selectpicker">
                          <option></option>
                 ...
                 <div class="wrap-input100 validate-input" data-validate="gender is required">
					...
					<%--<div class="container-login100-form-btn">
						...
						<div class="wrap-login100-form-btn">
                            ...
                            <asp:Button class="login100-form-btn" style="background-color:red" ID="Button1" runat="server" OnClick="Button1_Click1" Text="submit" />
                            </div> </div>
              <%--  </form>--%>
			</div>
		</div>
